        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameId = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GamePlays_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GamePlays_UserId_GameId_PlayDate",
                table: "GamePlays",
                columns: new[] { "UserId", "GameId", "PlayDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserFavorites_UserId_GameId",
                table: "UserFavorites",
